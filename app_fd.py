...
# For now, only compatible with the finedance dataset
DATASET = "finedance"
...
EXAMPLES = [
    # Train
    "000001-feedback-Street-Jazz",
    "000002-feedback-Street-Jazz",
    "000114-leyouji-Mix-Chinese",
    "000116-leyouji-Mix-Chinese",
    "002728-shuangren4_tanglanting-Classic-ShenYun",
    "003084-guiqulaixi-Mix-Chinese",
    "003450-xuanyue01-Folk-Dai",
    "004070-A-Street-Popping",
    "004072-A-Street-Popping",
    "004210-N-Street-Popping",
    "004212-N-Street-Popping",
    "004949-Run2U-Mix-Korean",
    
    # Test
    "000003-feedback-Street-Jazz",
    "000115-leyouji-Mix-Chinese",
    "002460-YeahUsherLilJon-Street-Hiphop",
    "002987-aini_maiding-Street-Jazz",
    "004430-meilideshenhua-Classic-ShenYun",
    "004654-panorama-Mix-Korean",
    
    # Val
    "002730-shuangren4_tanglanting-Classic-ShenYun",
    "003725-zhaiputao-Folk-Wei",
]
...
def finedance_keyid_to_babel_rendered_url(h3d_index, amass_to_babel, keyid):
    # Don't show the mirrored version of finedance
    if "M" in keyid:
        return None
...
keyid_to_url = partial(finedance_keyid_to_babel_rendered_url, h3d_index, amass_to_babel)
